...
execute unless score #has_godmode gcs.temp matches 1.. run tellraw @s [{"text":"[🛡] ","color":"gold","bold":true},{"text":"GOD MODE ","color":"yellow","bold":true},{"text":"ON","color":"green","bold":true}]
...
execute unless score #has_godmode gcs.temp matches 1.. run title @s actionbar [{"text":"⚡ ","color":"gold"},{"text":"INVINCIBLE","color":"yellow","bold":true},{"text":" ⚡","color":"gold"}]
...
execute if score #has_godmode gcs.temp matches 1.. run tellraw @s [{"text":"[🛡] ","color":"dark_gray","bold":true},{"text":"God mode ","color":"gray"},{"text":"disabled","color":"red"}]
...
execute if score #has_godmode gcs.temp matches 1.. run title @s actionbar [{"text":"⚠ ","color":"red"},{"text":"Vulnerable","color":"dark_red"},{"text":" ⚠","color":"red"}]
