...
execute unless score #has_speed gcs.temp matches 1.. run tellraw @s [{"text":"[⚡] ","color":"yellow","bold":true},{"text":"SPEED BOOST ","color":"gold","bold":true},{"text":"ACTIVE!","color":"green"}]
...
execute if score #has_speed gcs.temp matches 1.. run tellraw @s [{"text":"[⚡] ","color":"gray","bold":true},{"text":"Speed boost ","color":"dark_gray"},{"text":"removed","color":"red"}]
