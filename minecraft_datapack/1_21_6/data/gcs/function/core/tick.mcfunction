...
# Particle Aura efekti
execute as @a[scores={gcs.aura=1}] at @s run function gcs:effects/particle_aura_tick

# Freeze: her tick donuk player(s)yu yerinde tut + adventure modda kilitle
