...
# Grand firework show around the player

# Mesaj
tellraw @s [{"text":"[🎆] ","color":"light_purple","bold":true},{"text":"FIREWORK SHOW ","color":"gold","bold":true},{"text":"STARTING!","color":"yellow"}]
...
# Sound effects — layered explosions
...
title @a subtitle [{"text":"Firework Show!","color":"gold","bold":true}]
