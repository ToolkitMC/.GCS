...
execute if score #tf_state gcs.count matches 0 run tellraw @a [{"text":"[Time] ","color":"gold","bold":true},{"text":"Daylight cycle paused.","color":"yellow"}]
...
execute if score #tf_state gcs.count matches 1 run tellraw @a [{"text":"[Time] ","color":"gold","bold":true},{"text":"Daylight cycle resumed.","color":"green"}]
