...
execute if score @s gcs.auth matches 3.. run tellraw @s [{"text":"│ ","color":"gray"},{"text":"[🔧] ","color":"gold","bold":true},{"text":"Bakım Modu","color":"white","clickEvent":{"action":"suggest_command","value":"/function gcs:admin/maintenance {}"},"hoverEvent":{"action":"show_text","value":"Bakım modunu aç/kapat\n§7§oGerekli: Admin (Lv3)"}}]
